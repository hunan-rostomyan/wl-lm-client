...
var _hunan_rostomyan$wl_lm_client$Main$pageNotFound = {
	ctor: '::',
	_0: A2(
...
var _hunan_rostomyan$wl_lm_client$Main$pageHome = function (model) {
	return {
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$div,
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Available functions'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$href('#evaluate'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Text -> Perplexity'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$href('#next'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Text -> Next Word'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
...
var _hunan_rostomyan$wl_lm_client$Main$nextWordView = function (model) {
	return {
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$ul,
...
var _hunan_rostomyan$wl_lm_client$Main$perplexitiesView = function (model) {
	return {
		ctor: '::',
		_0: _elm_lang$html$Html$text(
			_elm_lang$core$Basics$toString(
				A2(
					_elm_lang$core$Maybe$withDefault,
					-1.0,
					_elm_lang$core$List$head(model.perplexities)))),
		_1: {ctor: '[]'}
	};
};
var _hunan_rostomyan$wl_lm_client$Main$next = function (text) {
	return _elm_lang$core$Basics$toFloat(
		_elm_lang$core$String$length(text)) - 1;
};
var _hunan_rostomyan$wl_lm_client$Main$Model = F4(
	function (a, b, c, d) {
		return {page: a, navState: b, text: c, perplexities: d};
	});
var _hunan_rostomyan$wl_lm_client$Main$NextWordsPage = {ctor: 'NextWordsPage'};
var _hunan_rostomyan$wl_lm_client$Main$EvaluatePage = {ctor: 'EvaluatePage'};
var _hunan_rostomyan$wl_lm_client$Main$NotFound = {ctor: 'NotFound'};
var _hunan_rostomyan$wl_lm_client$Main$Home = {ctor: 'Home'};
var _hunan_rostomyan$wl_lm_client$Main$routeParser = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _hunan_rostomyan$wl_lm_client$Main$Home, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_hunan_rostomyan$wl_lm_client$Main$EvaluatePage,
				_evancz$url_parser$UrlParser$s('evaluate')),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_hunan_rostomyan$wl_lm_client$Main$NextWordsPage,
					_evancz$url_parser$UrlParser$s('next')),
				_1: {ctor: '[]'}
			}
		}
	});
var _hunan_rostomyan$wl_lm_client$Main$decode = function (location) {
	return A2(_evancz$url_parser$UrlParser$parseHash, _hunan_rostomyan$wl_lm_client$Main$routeParser, location);
};
var _hunan_rostomyan$wl_lm_client$Main$urlUpdate = F2(
	function (location, model) {
		var _p0 = _hunan_rostomyan$wl_lm_client$Main$decode(location);
		if (_p0.ctor === 'Nothing') {
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{page: _hunan_rostomyan$wl_lm_client$Main$NotFound}),
...
var _hunan_rostomyan$wl_lm_client$Main$EvaluationResult = function (a) {
	return {ctor: 'EvaluationResult', _0: a};
};
var _hunan_rostomyan$wl_lm_client$Main$evaluateText = function (text) {
	return A2(
		_elm_lang$http$Http$send,
		_hunan_rostomyan$wl_lm_client$Main$EvaluationResult,
		_elm_lang$http$Http$getString('http://127.0.0.1:7777/eval/'));
};
var _hunan_rostomyan$wl_lm_client$Main$update = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'UrlChange':
				return A2(_hunan_rostomyan$wl_lm_client$Main$urlUpdate, _p1._0, model);
			case 'NavMsg':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
			...
			case 'Evaluate':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _hunan_rostomyan$wl_lm_client$Main$evaluateText(model.text)
				};
			case 'Next':
...
var _hunan_rostomyan$wl_lm_client$Main$Next = {ctor: 'Next'};
var _hunan_rostomyan$wl_lm_client$Main$Evaluate = {ctor: 'Evaluate'};
var _hunan_rostomyan$wl_lm_client$Main$TextChange = function (a) {
	return {ctor: 'TextChange', _0: a};
};
var _hunan_rostomyan$wl_lm_client$Main$pageEvaluate = function (model) {
	return {
		ctor: '::',
		_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$text(
								{
									ctor: '::',
									_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$id('text'),
									_1: {
										ctor: '::',
										_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$attrs(
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(_hunan_rostomyan$wl_lm_client$Main$TextChange),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
									...
									_rundis$elm_bootstrap$Bootstrap_Button$button,
									{
										...
										_1: {
											...
											_0: _rundis$elm_bootstrap$Bootstrap_Button$attrs(
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(_hunan_rostomyan$wl_lm_client$Main$Evaluate),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
					...
					_1: {
						...
						_0: A2(
							_rundis$elm_bootstrap$Bootstrap_Grid$col,
							{ctor: '[]'},
							_hunan_rostomyan$wl_lm_client$Main$perplexitiesView(model)),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
...
var _hunan_rostomyan$wl_lm_client$Main$pageNextWords = function (model) {
	return {
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$h5,
				...
				{ctor: '[]'},
				{
						...
						{ctor: '[]'},
						{
							...
							_1: {
								...
								_0: A2(
									_rundis$elm_bootstrap$Bootstrap_Button$button,
									{
										...
										_1: {
											...
											_0: _rundis$elm_bootstrap$Bootstrap_Button$attrs(
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(_hunan_rostomyan$wl_lm_client$Main$Next),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Compute'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
					...
					_1: {
						...
						_0: A2(
							_rundis$elm_bootstrap$Bootstrap_Grid$col,
							{ctor: '[]'},
							_hunan_rostomyan$wl_lm_client$Main$nextWordView(model)),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
...
var _hunan_rostomyan$wl_lm_client$Main$mainContent = function (model) {
	return A2(
		...
		function () {
			...
			switch (_p3.ctor) {
				case 'Home':
					return _hunan_rostomyan$wl_lm_client$Main$pageHome(model);
				case 'NotFound':
					return _hunan_rostomyan$wl_lm_client$Main$pageNotFound;
				case 'EvaluatePage':
					return _hunan_rostomyan$wl_lm_client$Main$pageEvaluate(model);
				default:
					return _hunan_rostomyan$wl_lm_client$Main$pageNextWords(model);
			}
		}());
};
var _hunan_rostomyan$wl_lm_client$Main$NavMsg = function (a) {
	return {ctor: 'NavMsg', _0: a};
};
var _hunan_rostomyan$wl_lm_client$Main$init = function (location) {
	var _p4 = _rundis$elm_bootstrap$Bootstrap_Navbar$initialState(_hunan_rostomyan$wl_lm_client$Main$NavMsg);
	var navState = _p4._0;
	var navCmd = _p4._1;
	var _p5 = A2(
		_hunan_rostomyan$wl_lm_client$Main$urlUpdate,
		location,
		{
			navState: navState,
			page: _hunan_rostomyan$wl_lm_client$Main$Home,
			text: '',
			perplexities: {ctor: '[]'}
		});
	var model = _p5._0;
...
var _hunan_rostomyan$wl_lm_client$Main$subscriptions = function (model) {
	return A2(_rundis$elm_bootstrap$Bootstrap_Navbar$subscriptions, model.navState, _hunan_rostomyan$wl_lm_client$Main$NavMsg);
};
var _hunan_rostomyan$wl_lm_client$Main$menu = function (model) {
	return A2(
		...
		A2(
			...
			A3(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('LM Client'),
					_1: {ctor: '[]'}
				},
				_rundis$elm_bootstrap$Bootstrap_Navbar$container(
					_rundis$elm_bootstrap$Bootstrap_Navbar$withAnimation(
						_rundis$elm_bootstrap$Bootstrap_Navbar$config(_hunan_rostomyan$wl_lm_client$Main$NavMsg))))));
};
var _hunan_rostomyan$wl_lm_client$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _hunan_rostomyan$wl_lm_client$Main$menu(model),
			_1: {
				ctor: '::',
				_0: _hunan_rostomyan$wl_lm_client$Main$mainContent(model),
				_1: {ctor: '[]'}
			}
		});
};
var _hunan_rostomyan$wl_lm_client$Main$UrlChange = function (a) {
	return {ctor: 'UrlChange', _0: a};
};
var _hunan_rostomyan$wl_lm_client$Main$main = A2(
	_elm_lang$navigation$Navigation$program,
	_hunan_rostomyan$wl_lm_client$Main$UrlChange,
	{view: _hunan_rostomyan$wl_lm_client$Main$view, update: _hunan_rostomyan$wl_lm_client$Main$update, subscriptions: _hunan_rostomyan$wl_lm_client$Main$subscriptions, init: _hunan_rostomyan$wl_lm_client$Main$init})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _hunan_rostomyan$wl_lm_client$Main$main !== 'undefined') {
    _hunan_rostomyan$wl_lm_client$Main$main(Elm['Main'], 'Main', undefined);
}
